...
export default function FuentesError({
  error,
  reset,
}: {
  ...
  React.useEffect(() => {
    console.error("[fuentes] error boundary:", error.message, error.digest);
  }, [error]);
      ...
      <Card className="border-status-danger/30">
        <CardHeader className="flex flex-row items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <CardTitle>No se pudo cargar el inspector de Fuentes</CardTitle>
            <CardDescription>
              Hubo un fallo en el servidor al consultar los conectores. Reintenta
              o vuelve a la home.
            </CardDescription>
          </div>
        </CardHeader>
